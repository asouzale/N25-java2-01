...
public class JavaFXExemplo01 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		//Posicionando botoões - eixo x
		btn01.setLayoutX(150);
		btn02.setLayoutX(10);
		//Posicionando botoões - eixo y
		btn01.setLayoutY(10);
		...
		//VBox root = new VBox();
		Group root = new Group(); //(posiciono onde eu quiser)
		//Adicionando botões no painel
		root.getChildren().addAll(btn02, btn01);
		//Criando a Scene
		Scene cena = new Scene(root, 600,800, Color.rgb(0, 70, 60));
		//Amarrando o no principal na tela
